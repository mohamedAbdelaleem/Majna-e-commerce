...
from .serializers import BrandApplicationOutSerializer, BrandApplicationStatusSerializer
...
class BrandsApplications(APIView):
    ...
    def get(self, request):
        ...
        data = BrandApplicationOutSerializer(data, many=True, context={'request':request}).data
...
class BrandApplication(APIView):
    ...
    def get(self, request, **kwargs):
        ...
        data = BrandApplicationOutSerializer(application, context={'request':request}).data
    ...
    def patch(self, request, **kwargs):
        ...
        return Response(data={"message": "Brand Application Status Updated Successfully"})
