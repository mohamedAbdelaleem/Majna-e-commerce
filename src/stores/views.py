...
class StoreCreateListView(APIView):
    ...
    def get(self, request, **kwargs):
        ...
        stores = StoreOutSerializer(stores, many=True).data
        data = {'stores': stores}
    ...
    def post(self, request, **kwargs):
        ...
        return Response(data={"message": "Store Created"}, status=status.HTTP_201_CREATED)
...
class StoreDisplayUpdateDeleteView(APIView):
    ...
    def get(self, request, **kwargs):
        ...
        store = StoreOutSerializer(store).data
